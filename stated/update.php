            ...
            <div class="col-sm-12 col-md-12 col-lg-12 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form action="queries/crud.php" method="post">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="radio" name="gender" value="female" class="form-check-input"><label for="sid" >Female</label>
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" name="qt" id="qt" class="form-control">
                            </div>

                            <div class="col-md-4 form-group">
                                <label for="sid">Year of Join</label>
                                <input type="text" name="yoj" id="yoj" class="form-control">
                            </div>

                            <div class="col-md-4 form-group">
                                <label for="sid">Parent Contact</label>
                                <input type="text" name="pcnt" id="pcnt" class="form-control">
                            </div>

                            <div class="col-md-4 form-group">
                                <label for="sid">Aadhaar Number</label>
                                <input type="text" name="adhar" id="adhar" class="form-control">
                            </div>
...
//    $fd=$_POST['fd'];
    ...
    $query = "Update student(sid, fsname, lsname,gender,mob,email,address,parentname,quota,yoj,pcontact,aadhar)
                values('$sid','$fname','$lname','$gender',$mb,'$mail','$adr','$pname','$qt',$yoj,'$pcnt','$adhar')";
