                ...
                <div class="col-12 col-md-10 d-none d-xl-block">
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        ...
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            <li><a href="queries/crud.php" class="nav-link">Insert</a></li>
                            <li><a href="queries/update.php" class="nav-link">Update</a></li>
                            <li><a href="queries/delete.php" class="nav-link">Delete</a></li>
                            <li><a href="queries/query.php" class="nav-link">Query</a></li>
...
<!--                    <h1>Welcome</h1>-->
<!--                    <p style="font-size: 32px;font-weight: bold;font-family: Playfair Display, serif;">To</p>-->
<!--                    <p class="mb-5" style="font-size: 32px;font-weight: bold;font-family: Playfair Display, serif;">MCA Department Student Counselling System</p>-->
                    <h1>Welcome</h1>
                    <h1>To</h1>
                    <!--            <p class="mb-5 customfont">MCA Department</p>-->
                    <h1 class="customfont align-self-center">Student Counselling System</h1>
                </div>
            </div>
        </div>
